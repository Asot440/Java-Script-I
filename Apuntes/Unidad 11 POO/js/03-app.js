...
class Persona extends Cliente{
    constructor(nombre, saldo,departamento){
        //traer las propiedas del padre se usa super
        super(nombre,saldo);
        this.departamento=departamento;
    }

    static Mensaje(){
        return `Hola Colaborador Bienvenido`;
    }

}

const Julio =new Persona('Julio',4000,'marketing');
console.log(Julio.MostrarDatos());
console.log(Cliente.Mensaje());
