/*
let tiene un ámbito de bloque, también es susceptible al "hoisting", 
pero no permite el uso de la variable antes de su declaración 
y no permite re-declarar la misma variable en el mismo ámbito.
*/
